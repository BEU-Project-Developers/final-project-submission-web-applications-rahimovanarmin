        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Event_Exhibition",
                        column: x => x.ExhibitionId,
                        principalTable: "Exhibition",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Event_Exhibition_ExhibitionId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArtworkArtStyle", x => new { x.ArtWorkId, x.ArtStyleId });
                    table.ForeignKey(
                        name: "FK_ArtworkArtStyle_ArtStyle_ArtStyleId",
                        column: x => x.ArtStyleId,
                        principalTable: "ArtStyle",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArtworkArtStyle_Artwork_ArtWorkId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArtworkArtStyle_ArtStyleId",
                table: "ArtworkArtStyle",
                column: "ArtStyleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Event_ExhibitionId",
                table: "Event",
                column: "ExhibitionId");

            migrationBuilder.CreateIndex(
                name: "IX_Event_ExhibitionId1",
                table: "Event",
